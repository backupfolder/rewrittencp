...
class Loading extends Phaser.Scene {
  ...
  preload() {
    /* loading des assets pour le chargement */ this.load.multiatlas('atlaspenguin-1', 'assets/json/atlaspenguin-1.json', 'assets');
    }
  
  create() {
    // affichage des assets du chargement
    ...
    this.load.multiatlas('matlasPenguinFeatures', 'assets/json/penguinfeatures.json', 'assets');
